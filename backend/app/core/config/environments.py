...
class DevelopmentSettings(Settings):
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5432/evalia_dev"
...
class StagingSettings(Settings):
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5432/evalia_staging"
    ...
    cors_origins: list[str] = [
        "https://staging.evalia.com",
        "https://evalia-staging.vercel.app",
    ]
...
class ProductionSettings(Settings):
    ...
    log_level: str = "INFO"
    structured_logging: bool = True
    log_file: Optional[str] = "/var/log/evalia/app.log"
