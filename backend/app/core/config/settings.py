...
class Settings(BaseSettings):
    ...
    database_url: Optional[str] = Field(
        default="postgresql://postgres:postgres@localhost:5432/evalia",
    ...
    kafka_group_id: str = Field(default="evalia_backend", description="Kafka consumer group ID")
    ...
    agent_type: str = Field(default="workflow", description="Agent architecture type")
    ...
    memory_type: str = Field(default="hybrid", description="Memory storage type")
    ...
    pinecone_index_name: str = Field(default="evalia-memory", description="Pinecone index name")
