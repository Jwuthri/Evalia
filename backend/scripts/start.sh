#!/bin/bash
# Start script for Evalia Backend

set -e

echo "🚀 Starting Evalia Backend..."
...
case $ENVIRONMENT in
    "development" | "dev")
        ...
        echo "   🔗 pgAdmin: http://localhost:5050 (admin@evalia.local / admin)"
...
echo ""
echo "🎉 Evalia Backend is starting up!"
